        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-header mt-7">
                    <span class="menu-header-text">Site Manager</span>
                </li>
                <li class="menu-item">
                    <a
                        href="{{route('admin.slider.index')}}"
                        class="menu-link">
                        <i class="menu-icon icon-base ri ri-printer-line"></i>
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a
                                ...
                                <div class="avatar avatar-online">
                                    <img src="/admin/assets/img/avatars/1.png" alt="alt" class="rounded-circle" />
                                </div>
                            </a>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar avatar-online">
                                                    <img src="/admin/assets/img/avatars/1.png" alt="alt" class="w-px-40 h-auto rounded-circle" />
                                                </div>
                                            </div>
